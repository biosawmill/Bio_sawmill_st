...
\floatfoot{20 interfeisas. Optimizavimo puslapis - po optimizavimo, pasirinkus vieno iš planų peržiūrą (iš arčiau). Mygtukas "Parsisiųsti" atidaro standartinį operacinės sistemos failo išsaugojimo langą. Išsaugojimo mygtukas atodaro 21 interfeisą (dialogą), o  "Istorijos" mygtukas 23 interfeisą (dialogą).}
\begin{figure}[!tph]
\hspace{-2cm}
\centering
