...
neviršija dešimties. \\
Detales galima įvesti rankiniu būdu bei importuoti ".csv" formatu. 
Taip pat yra mygtukas "Parsisiųsti importuojamo failo pavyzdį", skirtas atsiųsti \\
pavyzdinį ".csv" failą, kuriame parodoma kaip reikia suvesti detales į tokį failą. \\
