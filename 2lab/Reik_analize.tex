...
\section{Naudojimo atvejų aprašai(Use-cases)}
>>>>>>> 43f241f92a5396a3470fdc42fc8862fd5ba54ed0
...
\textbf{Kritiškumas}                                                                    & Būtinas\\ \hline
\textbf{Pradinės sąlygos}                                                               &  \begin{tabular}[c]{@{}l@{}}  Vartotojas yra teisingai nurodęs visus parametrus,\\ reikalingus optimizacijai, parametrų įvedimo lange \end{tabular}    \\ \hline
\textbf{Rezultatas}                                                                     &  Surandamas vienas arba keli optmizuoti pjovimo planai  \\ \hline
\textbf{\begin{tabular}[c]{@{}l@{}}
Tipinė eiga ir kiti\\ galimi variantai
\end{tabular}} &   
\begin{tabular}[c]{@{}l@{}} 
	1. Optimizacijos parametrų įvedimo lange vartotojas paspaudžia\\ optimizacijos padžios mygtuką.\\2. Optimizavimo algoritmas suranda optimalų/-ius pjovimo planus\\(planų kiekis priklauso nuo to, kiek skirtingų panelių dydžių\\ vartotojas nurodė įvesdamas optimizacijos parametrus).\\3. Sistemas pateiks optimizacijos rezultatus vartotojui.\end{tabular} \\ \hline
\end{tabular}
\end{frame}
...
% <<<<<<<<<<<<<<<<<<<<<<<<<<< SWIM LANE >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
\includegraphics[width=15cm]{swim.jpeg}
\end{document}
