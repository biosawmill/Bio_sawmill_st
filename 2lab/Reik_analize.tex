...
\textbf{Dalyviai}  			&	Vartotojas, administratorius						\\ \hline
\textbf{Paskirtis}  			&	Leisti prieigą prie vartotojo paskyros 			\\ \hline
\textbf{Kritiškumas} 		&	Būtinas\\ \hline
\textbf{Pradinės sąlygos}	&	Vartotojas turi būti įregistruotas sistemos 
								duomenų bazėje 									\\ \hline
\textbf{Rezultatas}			&  \begin{tabular}[c]{@{}l@{}}
									Vartotojas gavo prieigą prie savo paskyros \\ 
									bei gali atlikti pjovimo optimizaciją
								\end{tabular} 									\\ \hline
\textbf{
	\begin{tabular}[c]{@{}l@{}}
		Tipinė eiga ir kiti\\ galimi variantai
	\end{tabular}} 				&   
\begin{tabular}[c]{@{}l@{}}
1. Prisijungimo lange vartotojas suveda prisijungimo duomenis:\\ 
vartotojo vardą arba paštą ir slaptažodį.\\
2. Paspaudžia prisijungimo mygtuką.\\ 
3. Jeigu suvesti prisijungimo duomenys atitinka vartotojo įrašą \\
duomenų bazėje, tai įvyksta nukreipimas į atitinkančią paskyrą.\\
Kitu atveju vartotojui pranešama, jog prisijungimo duomenys \\
klaidingi. Vartotojas gali bandyti prisijungti 3 kartus iš naujo arba \\
spausti mygtuką prisijungimo duomenų atgavimui.
\end{tabular} \\ \hline
...
\textbf{Dalyviai}			&	Vartotojas, administratorius				\\ \hline
\textbf{Paskirtis}			&   Naudotojui sužinoti pamirštą slaptažodį	\\ \hline
\textbf{Kritiškumas}		 	&	Būtinas 									\\ \hline
\textbf{Pradinės sąlygos}	&  	Naudotojas užmiršęs slaptažodį. 			\\ \hline
...
\begin{tabular}[c]{@{}l@{}}
	...
	2. Atsidariusiame naujame lange nurodo savo el. pašto\\ 
	adresą ar vardą, su kuriais yra užsiregistravęs sistemoje.\\ 
	3. Vartotojas spaudžia patvirtinimo mygtuką.\\ 
	4. Jei el. paštas egzistuoja sistemos duomenų bazėje, juo bus\\ 
	nusiųstas slaptažodžio priminimas. Jei el. pašto atitikmens nerandama \\
