...
F5	& 	\begin{tabular}[c]{@{}l@{}}
			\colorbox{yellow}{Paskyros duomenų keitimo forma. Paprastas vartotojas turi  galėti pasikeisti}\\ \colorbox{yellow}{savo vartotojo vardą, slaptažodį ir el. paštą.
			Aministratorius papildomai dar gali}\\\colorbox{yellow}{ištrinti vartotojus, keisti optimizavimo galiojimo laikotarpį, bei priminti visus}\\\colorbox{yellow}{
...
F7	& 	\begin{tabular}[c]{@{}l@{}}\colorbox{yellow}{
...
F12 & 	\begin{tabular}[c]{@{}l@{}}\colorbox{yellow}{
			Pjūvio plano ruošinio (.pdf) atsisiuntimas. Failas atsiunčiamas į vartotojo įrenginį.}
		\end{tabular}									& 1, 3			\\ \hline
...
F14 	& 	\begin{tabular}[c]{@{}l@{}}
		...
		\end{tabular}									& 1, 3			\\ \hline
F15	& 	\begin{tabular}[c]{@{}l@{}}\colorbox{yellow}{
		...
		\end{tabular}
									& 1, 3			\\ \hline
F16	& 	\begin{tabular}[c]{@{}l@{}}\colorbox{green}{
...
Planuojama sistemą pateikti kaip paslaugą išoriniams vartotojams.                                                                                                                                                                                                                                                                                         												& F1, F2	, F3, F4, F5, F6, F7, F15, F16	\\ \hline
