...
\begin{tabular}[c]{@{}l@{}} 
	...
	2. Taip pat nurodomi reikalingų detalių:\\
		ilgiai (mm),	 pločiai (mm) ir kiekiai.\\
	Taip pat galima įkelti '.csv' formato failą, su ilgio, aukščio ir \\
	kiekio stulpeliais.\\\\
	...
	panelės matmenys galimi nuo 10mm iki 10000mm, o maksimalus \\
	kiekis - 10. \\\\
...
\begin{tabular}[c]{@{}l@{}} 
	1. Optimizuojamas pjovimo planas/planai, stengiantis panaudoti\\
	kuo mažiau panelių.\\
